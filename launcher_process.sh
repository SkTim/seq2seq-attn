...
#python preprocess.py --srcvocabfile data/demo.src.dict --targetvocabfile data/demo.src.dict --srcfile data/src-train-mixed.txt --targetfile data/targ-train-mixed.txt --srcvalfile data/src-val-mixed.txt --targetvalfile data/targ-val-mixed.txt --outputfile data/demo
...
#python preprocess.py --srcfile data/src-train-mixed.txt --targetfile data/targ-train-mixed.txt --srcvalfile data/src-val-mixed.txt --targetvalfile data/targ-val-mixed.txt --outputfile data/demo
