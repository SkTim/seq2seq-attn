...
th evaluate.lua -model models/double-st-model_final.t7 -src_file $ar_he_route/evaluation/test.input.tok.1 -output_file pred.txt -src_dict data/double-st.src.dict -targ_dict data/double-st.targ.dict
