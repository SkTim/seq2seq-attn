...
th evaluate.lua -model models/demo-model_epoch6.00_31.96.t7 -src_file $ar_he_route/evaluation/test.input.tok.1 -output_file pred.txt -src_dict data/demo.src.dict -targ_dict data/demo.targ.dict
